												...
												<table class="table no-border">
														<thead>
																<tr class="text-uppercase bg-lightest">
																		<th style="min-width: 250px"><span>products</span></th>
																		<th style="min-width: 100px"><span>price</span></th>
																		<th style="min-width: 100px"><span>deposit</span></th>
																		<th style="min-width: 150px"><span>agent</span></th>
																		<th style="min-width: 130px"><span>status</span></th>
																		...
																		<td class="pl-0 py-8">
																				<div class="d-flex align-items-center">
																						...
																						<div>
																								...
																								<span class="d-block">Pharetra, Nulla , Nec, Aliquet</span>
																						</div>
																				</div>
																		</td>
																		<td>
