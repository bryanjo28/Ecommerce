									...
									<div class="col-12">
										...
										<div class="row"><!-- start 4rd row -->
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="controls">
														<input type="text" name="product_tags_id" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags" required=""> 
										...
										<div class="row"><!-- start 6th row -->
											...
											<div class="col-md-6">
												...
												<div class="controls">
													<textarea name="short_descp_id"  class="form-control" required="" placeholder="Textarea text" required=""></textarea>
												</div>
												</div>
											</div>	<!-- end col 4-->
										</div>	<!-- end 6th row-->
